...
# feature
## fast learning
The main framework of the program relies on ``Model`` (``from core._model``) and ``Layer`` (``from core._layer``). Use them to quickly build and train the model you want.<br />
