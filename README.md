...
# feature
## fast learning
The main framework of the program relies on ``Model`` (``from core._model``) and ``Layer`` (``from core._layer``), which can import directly as ``from deepfree import Model, Layer``. You can quickly build and train the model by using them.<br />
